...
st.set_page_config(page_title="V6.6 Legacy PDF/Image OCSR", layout="wide")
...
st.title("🖼️ V6.6 — Legacy PDF/Image OCSR")
st.caption("Optional V6.5-compatible PDF/image workflow retained inside V6.6. Drawing/direct-graph input is recommended when exact structures are available.")
